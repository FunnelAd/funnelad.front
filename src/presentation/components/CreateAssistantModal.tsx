...
export default function CreateAssistantModal({ isOpen, onClose, onSave, assistant, isEditing = false }: CreateAssistantModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div ref={modalRef} className="bg-white/95 backdrop-blur-sm rounded-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl">
        <div className="p-6">
          {/* Header */}

...
import { templateService, type Template } from '@/core/services/templateService';
import {
  PlusIcon,
  PencilIcon,
  TrashIcon,
    ...
    <ProtectedRoute>
      <div className="p-6">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-semibold text-gray-900">{t('templates')}</h1>
          <button
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">{t('no_templates')}</h3>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {templates.map((template) => (
                  <tr key={template.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{getTypeLabel(template.type)}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
